...
public class InvoiceItemTest extends BaseTest {
	...
	public void testGetAllInvoiceItemsWithFilters() throws PayabbhiException {
		PayabbhiCollection<InvoiceItem> invoiceitems = InvoiceItem.all(new HashMap<String, Object>() {
			{
				put("count", 1);
			}
		});
	...
	public void testGetAllInvoiceItemsWithInvalidFilters() throws PayabbhiException {
		...
		InvoiceItem.all(new HashMap<String, Object>() {
			{
				put("count", null);
			}
		});
	...
	public void testCreateNewInvoiceItem() throws PayabbhiException {
		InvoiceItem invoiceitem = InvoiceItem.create(new HashMap<String, Object>() {
			{
				put("name", "Line Item");
				put("amount", 100);
				put("currency", "INR");
	...
	public void testCreateNewInvoiceItemWithLessParams() throws PayabbhiException {
		InvoiceItem.create(new HashMap<String, Object>() {
			{
				put("name", "Line Item");
				put("amount", 100);
			}
