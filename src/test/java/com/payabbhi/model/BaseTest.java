...
public class BaseTest {
  ...
  protected void mockFetcher() throws PayabbhiException, IOException {
    ...
    when(mf.fetch(
            Method.GET,
            "https://payabbhi.com/api/v1/invoiceitems/item_KI75WbBlizfzLZui/invoices",
            EMPTY_BODY))
    ...
    when(mf.fetch(
            Method.GET,
            "https://payabbhi.com/api/v1/invoiceitems/item_invalid/invoices",
            EMPTY_BODY))
        .thenReturn(respondWith("/api/v1/exceptions/invalidrequesterror.json", 400));
    ...
    when(mf.fetch(
            Method.POST, "https://payabbhi.com/api/v1/invoices/invc_invalid/void", EMPTY_BODY))
        .thenReturn(respondWith("/api/v1/exceptions/invalidrequesterror.json", 400));
